        ...
        <div class="box-body">
            <form action = "" method = "post" name = "UserCreateForm" enctype="multipart/form-data">
                ...
                <div class="row form-group">
                    <div class="col-md-4">
                        ...
                        <input class="form-control"
                               ...
                               title = "Informe o Nome de Contato para Emergências do <?= $title; ?>"
                               placeholder="Nome de Contato para Emergências do <?= $title; ?>" <?php if ($ClienteData['alterar']) echo 'disabled="disabled"'; ?>>
                    </div>
                    <div class="col-md-4">
                        ...
                        <input class="form-control mask-phone9"
                               ...
                               placeholder="Telefone para Emergências do <?= $title; ?>" <?php if ($ClienteData['alterar']) echo 'disabled="disabled"'; ?>>
                    </div>
                </div>
                <hr>
                <div class="row form-group">
                    <div class="col-md-2">
                        ...
                        <select class="form-control" name="alugado">
                            ...
                            <option value="Sim" <?=($ClienteData['alugado'] == 'Sim' ? 'selected="selected"' : '')?> <?php if ($ClienteData['alterar']) echo 'disabled="disabled"'; ?>>Sim</option>
                            <option value="Não" <?=($ClienteData['alugado'] == 'Não' ? 'selected="selected"' : '')?> <?php if ($ClienteData['alterar']) echo 'disabled="disabled"'; ?>>Não</option>
                        </select>
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-md-6">
                        ...
                        <input class="form-control"
                               ...
                               placeholder="Inquilino da <?= $title; ?>" <?php if ($ClienteData['alterar']) echo 'disabled="disabled"'; ?>>
                    </div>
                    <div class="col-md-2">
                        ...
                        <input class="form-control"
                               ...
                               placeholder="Data de Nascimento do Inquilino da <?= $title; ?>" <?php if ($ClienteData['alterar']) echo 'disabled="disabled"'; ?>>
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="form-control"
                               ...
                               title = "Informe o RG do Inquilino da <?= $title; ?>"
                               placeholder="RG do Inquilino da <?= $title; ?>" <?php if ($ClienteData['alterar']) echo 'disabled="disabled"'; ?>>
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-md-4">
                        ...
                        <input class="form-control mask-phone9"
                               ...
                               placeholder="Telefone do Inquilino da <?= $title; ?>" <?php if ($ClienteData['alterar']) echo 'disabled="disabled"'; ?>>
                    </div>
                    <div class="col-md-4">
                        <label>Celular</label>
                        <input class="form-control mask-phone9"
                               ...
                               placeholder="Celular do Inquilino da <?= $title; ?>" <?php if ($ClienteData['alterar']) echo 'disabled="disabled"'; ?>>
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-md-5">
                        ...
                        <input class="form-control"
                               ...
                               placeholder="E-mail do <?= $title; ?>" <?php if ($ClienteData['alterar']) echo 'disabled="disabled"'; ?>>
                    </div>
                </div>
                <hr>
                ...
                <div class="row form-group">
                    <div class="col-md-8">
                        ...
                        <input class="form-control"
                               ...
                               placeholder="Nome do Adminstrador da <?= $title; ?>" <?php if ($ClienteData['alterar']) echo 'disabled="disabled"'; ?>>
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-md-6">
                ...
                <div class="row form-group">
                    <div class="col-md-4">
                        ...
                        <input class="form-control"
                               ...
                               placeholder="Bairro do Adminstrador da <?= $title; ?>" <?php if ($ClienteData['alterar']) echo 'disabled="disabled"'; ?>>
                    </div>
                    <div class="col-md-4">
                        <label>Cidade</label>
                        <input class="form-control"
                               ...
                               placeholder="Cidade do Adminstrador da <?= $title; ?>" <?php if ($ClienteData['alterar']) echo 'disabled="disabled"'; ?>>
                    </div>
                </div>
                ...
                <div class="row form-group">
                    <div class="col-md-4">
                        <label>Estado</label>
                        <select class="form-control" name="estado_admin" <?php if ($ClienteData['alterar']) echo 'disabled="disabled"'; ?>>
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="form-control mask-cep"
                               ...
                               placeholder="CEP do Adminstrador da <?= $title; ?>" <?php if ($ClienteData['alterar']) echo 'disabled="disabled"'; ?>>
                    </div>
                ...
                <div class="row form-group">
                    <div class="col-md-4">
                        ...
                        <input class="form-control mask-phone9"
                               ...
                               placeholder="Telefone do Adminstrador da <?= $title; ?>" <?php if ($ClienteData['alterar']) echo 'disabled="disabled"'; ?>>
                    </div>
                    <div class="col-md-4">
                        <label>E-mail</label>
                        <input class="form-control"
                               ...
                               placeholder="E-mail do Adminstrador da <?= $title; ?>" <?php if ($ClienteData['alterar']) echo 'disabled="disabled"'; ?>>
                    </div>
                </div>
