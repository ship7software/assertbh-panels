...
$taxa_boleto = $readConfig->getResult()[0]['taxa'];;
...
$dadosboleto["nosso_numero"] = $readCobranca->getResult()[0]['numero_documento'];  // Nosso numero sem o DV - REGRA: M�ximo de 11 caracteres!
...
$dadosboleto["demonstrativo1"] = $readConfig->getResult()[0]['demonstrativo1'];
$dadosboleto["demonstrativo2"] = $readConfig->getResult()[0]['demonstrativo2'];
$dadosboleto["demonstrativo3"] = $readConfig->getResult()[0]['demonstrativo3'];
$dadosboleto["instrucoes1"] = $readConfig->getResult()[0]['instrucoes1'];
$dadosboleto["instrucoes2"] = $readConfig->getResult()[0]['instrucoes2'];
$dadosboleto["instrucoes3"] = $readConfig->getResult()[0]['instrucoes3'];
$dadosboleto["instrucoes4"] = $readConfig->getResult()[0]['instrucoes4'];
