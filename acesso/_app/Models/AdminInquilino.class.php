...
class AdminInquilino {
    ...
    public function ExeDelete($UserId) {
        ...
        if (!$readUser->getResult()):
            $this->Error = ['Oppsss, você tentou remover um inquilino que não existe no sistema!', DS_ERROR];
            $this->Result = false;
        else:
    ...
    private function Create() {
        ...
        if ($Create->getResult()):
            $this->Error = ["O inquilino <b>{$this->Data['nome']}</b> foi cadastrado com sucesso no sistema!", DS_ACCEPT];
    ...
    private function Update() {
        ...
        if ($Update->getResult()):
            $this->Error = ["O inquilino <b>{$this->Data['nome']}</b> foi atualizado com sucesso!", DS_ACCEPT];
            $this->Result = true;
        endif;
    }
    ...
    private function Delete() {
        ...
        if ($Delete->getResult()):
            $this->Error = ["Inquilino removido com sucesso do sistema!", DS_ACCEPT];
            $this->Result = true;
        endif;
    }
