...
if ($ClienteData && $ClienteData['SendPostForm']):
    ...
    $cadastra = new AdminRepresentante;
    $cadastra->ExeCreate($ClienteData);

    if ($cadastra->getResult()):
        header("Location: painel.php?exe=representantes/update&create=true&userid={$cadastra->getResult()}");
    else:
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="painel.php?exe=representantes/index">Representantes</a></li>
...
<section class="content">
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Cadastro de Representantes</h3>
        </div>
        <div class="box-body">
                ...
                <div class="row form-group">
                    <div class="col-md-8">
                        ...
                        <input class="form-control"
                               ...
                               title = "Informe o Nome do Representante"
                               required
                ...
                <div class="row form-group">
                    <div class="col-md-3">
                        ...
                        <input class="form-control"
                               ...
                               title = "Informe a Senha do Representante [ de 6 a 12 caracteres! ]"
                               pattern = ".{6,12}"
                               required
                               placeholder="Senha do Representante" >
                    </div>
                </div>
        ...
        <div class="box-footer">
            <div class="row form-group col-lg-12">
                <span class="icon-input-btn"><span class="fa fa-hdd-o"></span><input type="submit" name="SendPostForm" value="Salvar Representante" class="btn btn-primary" /></span>
                <a href="painel.php?exe=representantes/index" class="btn btn-danger"><i class="fa fa-ban"></i> Cancelar</a>
            </div>
            </form>
        </div><!-- /.box-footer-->
    </div><!-- /.box -->
