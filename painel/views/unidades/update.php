    ...
    <div class="box">
        ...
        <div class="box-footer">
            <div class="row form-group col-lg-12">
                ...
                <a href="painel.php?exe=<?=$modulo?>/indexcond&id=<?=$idcond?>" class="btn btn-danger"><i class="<?=$botaoClass ?>"></i> <?=$botaoCR ?></a>
            </div>
            </form>
        </div><!-- /.box-footer-->
    </div><!-- /.box -->
