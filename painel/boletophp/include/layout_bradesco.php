...
<a href="javascript:window.print()"><img src="imagens/printer.png" alt="Imprimir Boleto" id="print-button" style="width: 30px"/> Imprimir Boleto</a>
...
<table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
    <tr>
        ...
        <td class=ti
            ...
            <?php echo $dadosboleto["telefones"]; ?><br>
...
<table cellspacing=0 cellpadding=0 border=0>
    ...
    <tr>
        ...
        <td class=ct valign=top width=7 height=13><img height=13 src=imagens/1.png width=1 border=0></td>
        <td class=ct valign=top width=120 height=13>Nosso número
        </td>
    </tr>
    <tr>
...
<table cellspacing=0 cellpadding=0 border=0>
    ...
    <tr>
        ...
        <td class=ct width=7 height=12></td>
        <td class=ct width=88>Autenticaçãoo
            mecânica
        </td>
    </tr>
    <tr>
...
<table cellspacing=0 cellpadding=0 border=0>
    ...
    <tr>
        ...
        <td class=ct valign=top width=7 height=13><img height=13 src=imagens/1.png width=1 border=0></td>
        <td class=ct valign=top width=153 height=13>Número do documento
        </td>
        <td class=ct valign=top width=7 height=13><img height=13 src=imagens/1.png width=1 border=0></td>
