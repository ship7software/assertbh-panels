                        ...
                        foreach ($read->getResult() as $user):
                            ...
                            <tr>
                                ...
                                <td><?php if ($tipo_doc == 'docgeraisinc'): echo "Documentos Gerais";
                                    ...
                                    ?></td>
                                <td><a href="<?= BASE.'/uploads/documentos/'.$tipo_doc.'/'.$id_condominio.'/'.$arquivo ?>" target="_blank"><?= $arquivo ?></a></td>
                                <td>
                                    <a class="btn btn-xs btn-primary" href="<?= BASE.'/uploads/documentos/'.$tipo_doc.'/'.$id_condominio.'/'.$arquivo ?>" target="_blank" title="Download"><i class="glyphicon glyphicon-download-alt" ></i></a>
                                </td>
                            </tr>
