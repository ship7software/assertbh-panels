...
if (!$login->CheckLogin()):
    unset($_SESSION['userloginc']);
    header('Location: index.php?exe=restrito');
else:
    $userlogin = $_SESSION['userloginc'];
endif;
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <?php extract($_SESSION['userloginc']); ?>
                                <?= Check::ImageUserAvatarMini('../uploads/condominios/'.$imagem); ?>
                                <span class="hidden-xs"><?= "{$nome}"; ?></span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                <li class="user-header">
                                    <?= Check::ImageUserAvatar('../uploads/condominios/'.$_SESSION['userloginc']['imagem']); ?>
                                    <p><small><?= "{$nome}"; ?></small></p>
                                    <p><small><?= "{$email}"; ?></small></p>
                                </li>
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="painel.php?exe=condominios/update&userid=<?=$id?>" class="btn btn-default btn-flat">Perfil</a>
                                    </div>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li><a href="painel.php?exe=condominios/update&userid=<?=$id?>"><i class="fa fa-building-o fa-fw"></i> <span>Cadastro</span></a></li>
...
<script type="text/javascript" src="__jsc/sweetalert.min.js"></script>
    ...
    <script type="text/javascript" src="__jsc/datatables-tabelas.js?version=20170650"></script>
